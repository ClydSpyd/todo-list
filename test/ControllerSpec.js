...
describe('controller', function () {
	...
	it('should show entries on start-up', function () {
		...
		var data = JSON.parse(localStorage['todos-vanillajs']);
	...
	it('should set the "clear completed" button', function () {
		var todo = {id: 123, title: 'my todo', completed: true};
		setUpModel([todo]);
	...
	describe('element removal', function () {
		it('should remove an entry from the model', function () {
			...
			subject.setView('');
			view.trigger('itemRemove', {id: 123});
		...
		it('should remove an entry from the view', function () {
			...
			expect(view.render).toHaveBeenCalledWith('removeItem', 123);
		});
	...
	describe('remove completed', function () {
		it('should remove a completed entry from the model', function () {
			...
			expect(model.remove).toHaveBeenCalledWith(123, jasmine.any(Function));
		});
	...
	describe('element complete toggle', function () {
		...
		it('should update the view', function () {
			...
			view.trigger('itemToggle', {id: 123, completed: false});

			expect(view.render).toHaveBeenCalledWith('elementComplete', {id: 123, completed: false});
		});
	});
